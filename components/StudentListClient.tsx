    ...
    return (
        <div className="space-y-4 pt-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                <div className="relative flex-1">
                    ...
                    <input 
                        ...
                        className="w-full h-11 pl-10 pr-4 rounded-md bg-white border border-gray-200/60 text-sm focus:outline-none focus:ring-2 focus:ring-[#9B51E0]/20 shadow-sm"
                    />
                </div>
                <div className="relative w-full sm:w-64">
                    <select className="w-full h-11 px-4 appearance-none rounded-md bg-white border border-gray-200/60 text-sm text-gray-600 focus:outline-none focus:ring-2 focus:ring-[#9B51E0]/20 shadow-sm">
            ...
            <div className="bg-white/40 backdrop-blur-xl border border-white/60 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.05)] rounded-2xl overflow-hidden">
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="border-b border-gray-200/50">
                                <th className="px-6 py-4 text-[10px] font-extrabold tracking-widest text-gray-900 uppercase">Student Name</th>
                                <th className="px-6 py-4 text-[10px] font-extrabold tracking-widest text-gray-900 uppercase">Email</th>
                                <th className="px-6 py-4 text-[10px] font-extrabold tracking-widest text-gray-900 uppercase">Country</th>
                                <th className="px-6 py-4 text-[10px] font-extrabold tracking-widest text-gray-900 uppercase">Status</th>
                                <th className="px-6 py-4 text-[10px] font-extrabold tracking-widest text-gray-900 uppercase w-40">Application<br/>Creation Date</th>
                                <th className="px-6 py-4 text-[10px] font-extrabold tracking-widest text-gray-900 uppercase">Action</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-gray-200/30">
                            {students.length === 0 ? (
                                ...
                                <tr key={student.id} className={`hover:bg-white/40 transition-colors ${deletingId === student.id ? 'opacity-50' : ''}`}>
                                    <td className="px-6 py-4">
                                        <div className="flex flex-col">
                                            <Typography as="span" className="text-sm font-bold text-gray-900">{student.profile?.name}</Typography>
                                            <Typography as="span" className="text-[10px] text-gray-500 font-medium uppercase tracking-wider mt-0.5">ID: {student.id?.slice(0, 8)}</Typography>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4">
                                        <Typography as="span" className="text-sm font-medium text-gray-700">{student.profile?.email || "-"}</Typography>
                                    </td>
                                    <td className="px-6 py-4">
                                        <Typography as="span" className="text-sm font-medium text-gray-700">{student.country || "-"}</Typography>
                                    </td>
                                    <td className="px-6 py-4">
                                        <span className="inline-flex items-center px-3 py-1 rounded-full bg-blue-500 text-white text-[10px] font-bold uppercase tracking-wider shadow-sm">
                                            CREATED
                                        </span>
                                    </td>
                                    <td className="px-6 py-4">
                                        <div className="flex flex-col">
                                            <Typography as="span" className="text-sm font-medium text-gray-800">
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-3 text-gray-600">
                                            ...
                                            <Link href={`/dashboard/student/${student.id}/edit`} className="hover:text-purple-600 transition-colors" title="Edit Profile">
                ...
                {/* Pagination */}
                <div className="flex items-center justify-between px-6 py-4 border-t border-gray-200/50">
                    <div className="flex items-center text-xs font-medium text-gray-600 space-x-1">
                        <Typography as="span" className="text-inherit">Showing</Typography>
                        <Typography as="span" className="font-bold text-gray-900">{students.length}</Typography>
                    ...
                    <div className="flex items-center gap-2">
                        <button className="size-8 rounded-lg bg-white/60 hover:bg-white flex items-center justify-center border border-gray-200/50 transition-colors">
