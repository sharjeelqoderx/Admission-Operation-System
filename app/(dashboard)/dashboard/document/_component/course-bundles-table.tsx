                        ...
                        <TableBody className="bg-white/45">
                            {bundles.map((bundle, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        <TableCell className="px-6 py-5 max-w-[280px] overflow-hidden">
                                                ...
                                                <div className="min-w-0 flex-1">
                                                    <Tooltip>
                                                        <TooltipTrigger asChild>
                                                            <div className="flex items-center gap-1.5 cursor-default overflow-hidden">
                                                                <Typography
                                                                    font="text"
                                        ...
                                        <TableCell className="px-6 py-5 min-w-[120px] max-w-[150px]">
                                            {bundle.courses.length === 0 ? (
                                                ...
                                                <Tooltip>
                                                    <TooltipTrigger asChild>
                                                        <span className="text-sm text-gray-700 line-clamp-2 cursor-default">
                                                ...
                                                <div className="text-sm text-gray-700 space-y-1 min-w-0">
                                                    {bundle.courses.slice(0, 2).map((course) => (
                                                        <Tooltip key={course.id}>
                                                            <TooltipTrigger asChild>
                                                                <div className="truncate cursor-default line-clamp-2">
                                                                    {course.name}
                                                                </div>
                                                            </TooltipTrigger>
                                                            <TooltipContent>
