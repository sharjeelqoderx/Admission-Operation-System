...
export const RejectApplicationDialog = memo(function RejectApplicationDialog({
    open,
    studentName,
    isSubmitting,
    errorMessage,
            ...
            <DialogContent className="sm:max-w-md">
                ...
                <div className="space-y-4">
                    <Typography as="p" className="text-sm text-muted-foreground">
                        ...
                        &apos;s application. This will be recorded in the review history.
                    </Typography>
                ...
                <DialogFooter>
                    ...
                    <Button
                        ...
                        disabled={isSubmitting}
                    >
                        {isSubmitting ? "Submitting..." : "Reject Application"}
                    </Button>
                </DialogFooter>
            </DialogContent>
        </Dialog>
